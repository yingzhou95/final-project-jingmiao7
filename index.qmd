...
```{r}
# Step 5: Plot observed data and fitted phenology curves
ggplot() +
  # Observed NDVI points
  ...
  # Fitted harmonic regression curves
  ...
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 16),  # Center-align title and adjust size
